...
public class CampfireManagementScreen extends Screen {
    ...
    // 1.21.5 still uses the old keyPressed(int, int, int) signature — KeyInput doesn't exist yet
    @Override
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        // 1.21.5 uses RenderLayer::getGuiTextured (same as 1.21.2–1.21.4)
    ...
    private void renderSlotTooltip(DrawContext context, int slotIndex, CampfireGuiPacket.SlotInfo slot, int mouseX, int mouseY) {
        ...
        // withShadowColor() is available from 1.21.5 onward
